...
type TransactionRepository interface {
	...
	FindTransactionByDonationIDAndStatusSucces(donationId int) ([]models.Transaction, error)
	...
	UpdateTransaction(status string, orederId int) (models.Transaction, error)
...
func (r *repository) FindTransactionByDonationIDAndStatusSucces(donationId int) ([]models.Transaction, error) {
	var transactions []models.Transaction
	err := r.db.Where("donation_id=?", donationId).Where("status=?", "success").Preload("Donation").Preload("User").Find(&transactions).Error
